...
public class ReturnLibraryView {
    ...
    private ReturnLibraryController controller;
    
    public void setController(ReturnLibraryController controller) {
        this.controller = controller;
    }
    
    public void initialize(Stage primaryStage) {
        // Set the title of the window
        primaryStage.setTitle("Library Return System");
        ...
        returnButton.setOnAction(e -> controller.handleReturnAction());
        
        statusLabel = new Label("Enter information and click Return Book");
